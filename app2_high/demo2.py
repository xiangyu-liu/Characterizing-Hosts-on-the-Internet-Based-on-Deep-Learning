...
model.load_model("model_8002")  # 加载已存储的模型
...
# for website in ["amazon"]:
# 	with open(website+".json", "r") as f:
# 		content = f.read()
# 		X_test.append(json.loads(content))
# 		Y_test.append(0)
...
print(X.shape)
mask = np.ones((5987,))
unwanted = [1501, 1502, 1503, 1504, 1505, 1506, 1507, 1508, 4550, 4551, 4552, 4553, 4554, 4555, 4556, 4557, 4558, 4559,
            4560, 4561, 4562, 4563, 4564, 17, 18, 19, 20, 285, 286, 287, 288, 601, 602, 603, 604, 605, 606, 607, 1557,
            1558, 1559, 1560, 1561, 1562, 1563, 1564, 1565, 1566, 1567, 1568, 1569, 1570, 1571, 1572, 1573, 1574, 3196,
            3197, 3198, 3199, 4656, 4657, 4658, 4659, 4660, 4661, 4662, 4663, 4664, 4665, 4666, 4667, 4668, 4669, 4670,
